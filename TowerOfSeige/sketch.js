...
function setup() {
  ...
  BlockBlue8 = new Box(330, 183, 20, 20);

  BlockBlue9 = new Box(340, 183, 20, 20);
  ...
  //third level
  BlockBlue10  = new Box(202, 182, 20, 20);

  BlockBlue11  = new Box(220, 182, 20, 20);

  BlockBlue12 = new Box(240, 182, 20, 20);

  BlockBlue13 = new Box(260, 182, 20, 20);

  BlockBlue14 = new Box(280, 182, 20, 20);

  BlockBlue15 = new Box(300, 182, 20, 20);

  BlockBlue16 = new Box(320, 182, 20, 20);
